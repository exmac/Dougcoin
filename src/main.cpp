...
// Copyright (c) 2013 The Dougcoin developers
...
uint256 hashGenesisBlock("0x00000ac2381a73fa0b6c2c0dc63889ea8c3519a05aa06116e38e608b2245f51a");
static const unsigned int timeGenesisBlock = 1392291895;
...
static const int64 nBlockRewardStartCoin = 10240 * COIN;
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    // Subsidy is cut in half every 86400 blocks (30 days)
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000d566e81819674232b8b9b7be9e3ea831d9faa33606b4aaba4bfb4112b44");
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "Dougcoin February 13 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 11575489;

        if (fTestNet)
        {
            block.nTime    = 1392093880;
            block.nNonce   = 905133645;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x9bc36a68efab7304f1c694b5c6b4fc20705f7c2fc964dbab8a040db945453659"));
