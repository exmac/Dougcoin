...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Dougcoin: links)
...
{
    // clicking on Dougcoin: URLs creates FileOpen events on the Mac:
